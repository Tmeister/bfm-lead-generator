						...
						<fieldset class="screen">
							<div class="centered">
								<div class="bfm-field">
									...
									<input type="text" name="bfm-name" class="bfm-name" data-parsley-group="block2" required />
								</div>
								<div class="bfm-field">
						...
						<fieldset class="screen">
							<div class="centered">
								...
								<div class="bfm-field">
									...
									<input type="radio" class="radio" name="property-manager" value="no" data-parsley-group="block3" /> No
								</div>
							</div>
						</fieldset>
						<fieldset class="screen">
							<div class="centered">
								<div class="bfm-field">
									...
									<textarea id="bfm-comments" data-parsley-group="block4"></textarea>
								</div>
							</div>
						</fieldset>
						<fieldset class="screen">
